...
class ResultSnackAdapter : ListAdapter<ResultSnackDto, ResultSnackAdapter.ResultSnackViewHolder>(ResultSnackDiffCallback) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultSnackViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.row_snack_result, parent, false)
    ...
    class ResultSnackViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        private var resultSnackNameTextView : TextView = itemView.findViewById(R.id.result_snack_name)
        private var resultSnackCountTextView : TextView = itemView.findViewById(R.id.result_snack_count)
